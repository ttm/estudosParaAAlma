...
# use pillow (https://pypi.org/project/Pillow/) to define the functions:
def moveto(x, y):
    # simple moveto using pillow
    pass
def lineto(x, y):
    # simple lineto using pillow
    pass
...
for  k in range(1, 2 ** ndim):  # might be using 0 elements in x1 & y1
